...
func:function()
{
	...
	*/
	...
	G.funcs['new game blurb']=function()
	{
		...
		'</div>'+
		'<div class="par fancyText bitBiggerText">Votre tribu a trouvé une place où s'installer dans ces regions sauvages.<br>Les ressources sont rares, et tout le monde commence à rechercher de la nourriture.</div>'+
		'<div class="par fancyText bitBiggerText">Vous apparissez comme le chef de la tribu. Ils vous appellent :</div>';
		return str;
	}
	
	G.funcs['new game']=function()
	{
		var str='Votre nom est '+G.getName('ruler')+''+(G.getName('ruler').toLowerCase()=='orteil'?' <i>(mais ça n\'est pas toi, non ?)</i>':'')+', ruler of '+G.getName('civ')+'. Your tribe is primitive, but full of hope.<br>The first year of your legacy has begun. May it stand the test of time.';
